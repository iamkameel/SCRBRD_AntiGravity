      ...
      >
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 relative z-10">
          ...
          <div className="lg:ml-auto flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto">
             <div className="flex items-center gap-4 p-1 rounded-2xl border bg-zinc-100 dark:bg-white/5 border-zinc-200 dark:border-white/10">
                <button 
             ...
             <Button className="h-14 px-8 rounded-2xl font-black text-[10px] uppercase tracking-widest shadow-2xl bg-emerald-500 hover:bg-emerald-400 text-white">
