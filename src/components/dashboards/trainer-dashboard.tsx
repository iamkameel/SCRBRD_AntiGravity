  ...
  if (loading) {
      return (
        <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
          ...
          <p className="text-[10px] font-black uppercase tracking-[0.2em]" style={{ color: D.textMuted }}>Syncing Fitness Data Hub...</p>
        </div>
      );
  }
  ...
  return (
    <div className="space-y-10 pb-12 animate-in fade-in duration-500">
          ...
          >
            <div className="p-8 pb-10 flex flex-row items-center justify-between" style={{ borderBottom: `1px solid ${D.rose}20`, background: `${D.rose}05` }}>
              <div>
                ...
                <p className="text-[10px] font-black uppercase tracking-widest mt-1 opacity-50" style={{ color: D.textMuted }}>Athletes currently restricted from maximum performance outputs</p>
              </div>
              <Badge className="font-black text-[10px] uppercase tracking-widest px-4 py-1.5 rounded-full" style={{ background: `${D.rose}20`, color: D.rose, border: `1px solid ${D.rose}30` }}>
                  ...
                  >
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] font-bold uppercase tracking-widest opacity-60" style={{ color: D.textMuted }}>{player.teamIds?.join(' • ') || 'INDEPENDENT ATHLETE'}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-6 pr-2">
                      <Badge className="text-[9px] font-black uppercase tracking-widest px-3 py-1 rounded-lg border-0" style={{ background: `${D.rose}15`, color: D.rose }}>RESTRICTED</Badge>
                      <div 
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:mt-[-1rem]">
        ...
        <div 
          className="rounded-3xl overflow-hidden shadow-xl border flex flex-col"
        ...
        >
          <div className="p-8 border-b flex flex-row items-center justify-between" style={{ borderColor: D.border, background: D.surf2 }}>
            ...
            <Button variant="ghost" className="h-9 font-black text-[9px] uppercase tracking-widest px-6 rounded-2xl border" style={{ borderColor: D.border, color: D.indigo, background: D.surf1 }}>
              VIEW ARCHIVE
            </Button>
          </div>
            ...
            {[
              ...
              >
                <div className="mr-8 text-center min-w-[70px] pr-8" style={{ borderRight: `1px solid ${D.border}` }}>
                  ...
                  <div className="text-[9px] font-black uppercase tracking-[0.2em] opacity-40" style={{ color: D.textMuted }}>{session.period}</div>
                </div>
                <div className="flex-1">
                  ...
                  <div className="text-[10px] font-bold uppercase tracking-widest opacity-40" style={{ color: D.textMuted }}>{session.subt}</div>
                </div>
                <div 
        ...
        >
          <div className="p-8 border-b flex flex-row items-center justify-between" style={{ borderColor: D.border, background: D.surf2 }}>
            ...
            <Badge className="font-black text-[9px] uppercase tracking-widest px-4 py-1.5 rounded-full" style={{ background: `${D.amber}15`, color: D.amber, border: `1px solid ${D.amber}30` }}>
              CYCLE 12
            </Badge>
          </div>
          <div className="p-6 space-y-4">
            {[
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="font-black uppercase tracking-[0.2em] text-[9px]" style={{ color: item.color }}>{item.label}</span>
                </div>
