        ...
        <div className="space-y-6 font-sans text-[#f0f4ff]">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 border-b border-white/10 pb-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-bold font-['Syne',sans-serif] tracking-tight">Track & Field Athletics Meet Engine</h1>
                        <p className="text-xs text-slate-400 font-mono">{meet.title} • {meet.venueName}</p>
                    </div>
                </div>

                <Badge className="bg-amber-500/20 text-amber-300 border border-amber-500/30 font-mono text-xs px-3 py-1 flex items-center gap-1.5 animate-pulse">
            ...
            <Card className="p-6 bg-slate-900/90 border border-white/10 rounded-3xl shadow-xl backdrop-blur-2xl text-slate-100 space-y-4">
                <div className="flex justify-between items-center border-b border-white/10 pb-3">
                    ...
                    <span className="text-xs font-mono text-slate-400">Victor Ludorum Race</span>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div className="md:col-span-4 space-y-3">
                    <h3 className="text-xs font-mono font-bold text-slate-400 uppercase tracking-wider">Meet Events ({meet.events.length})</h3>
                        ...
                        {meet.events.map((ev) => (
                            ...
                            >
                                <div className="flex justify-between items-center">
                                    ...
                                    <Badge className="text-[9px] bg-white/10 text-slate-300 border-white/10">
                                        {ev.category}
                                    </Badge>
                                </div>
                ...
                <div className="md:col-span-8">
                    <Card className="p-6 bg-slate-900/90 border border-white/10 rounded-3xl shadow-xl backdrop-blur-2xl text-slate-100 space-y-6">
                        <div className="flex justify-between items-start border-b border-white/10 pb-4">
                            <div>
                                <div className="text-xs font-mono text-amber-400 uppercase tracking-wider">{activeEvent?.category} Event Leaderboard</div>
                        ...
                        <div className="space-y-3 font-mono text-xs">
                            ...
                            {activeEvent?.results.map((res) => (
                                <div key={res.swimmerOrAthleteName} className="grid grid-cols-12 gap-2 items-center p-3 bg-white/5 border border-white/5 rounded-xl">
                                    <div className="col-span-1 font-bold text-amber-400">#{res.place}</div>
                                    ...
                                    <div className="col-span-2 text-slate-300">{res.houseOrSchool}</div>
                                    <div className="col-span-3 font-bold text-cyan-400">
