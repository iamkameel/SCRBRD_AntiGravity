...
import { fmtOv, getPlayerName, SR, Econ } from './helpers';

function RichScorecardPanelImpl({liveScore,allPlayers,strikerId,nonStrikerId,bowlerId}:{
...
export const RichScorecardPanel = memo(RichScorecardPanelImpl);
