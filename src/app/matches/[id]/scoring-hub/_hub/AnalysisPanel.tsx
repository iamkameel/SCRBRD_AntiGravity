...
import { D, type AnalysisSubTab } from './design';
import { Lbl, Badge, SignalBar } from './primitives';
import { buildSignals, getPlayerName } from './helpers';
import { WagonWheel } from './WagonWheel';
import { IntelPanel } from './IntelPanels';

function ManhattanChartImpl({liveScore}:{liveScore:any}) {
...
export const ManhattanChart = memo(ManhattanChartImpl);

function AnalysisPanelImpl({liveScore,subTab,onSubTab,allPlayers,overs,target,isChase,wagonBallLog,wagonCoords,onWagonAim,wagonView,onWagonView,hiddenLines,onToggleLine}:{
...
export const AnalysisPanel = memo(AnalysisPanelImpl);
